...
def euler_deconv_plt(data,xi,yi,zi,shape,area,SI,windowSize):
    """
    Euler deconvolution - solves the system of equations
    for each moving data window
    
    This is the same function as above but return the estimates for the plateau
    plot. We generated a new function in order to help users but they do the 
    same things. In this case there is no selection of solutions, all are 
    displayed.
    ...
    * estimates_plt : 2d-array
        x, y, z and base-level estimates, all estimates 
    """   
